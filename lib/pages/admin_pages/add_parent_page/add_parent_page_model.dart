...
import 'add_parent_page_widget.dart' show AddParentPageWidget;
import 'package:flutter/material.dart';

class AddParentPageModel extends FlutterFlowModel<AddParentPageWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in AddParentPage widget.
